        ...
        <>
            ...
            <div className="footer">
                ...
                <div className="container d-flex justify-content-center align-items-center py-4 flex-column flex-md-row">
                    ...
                    <div className="col-lg-4 mb-5 mb-md-0 d-flex flex-column flex-md-row justify-content-center pt-5 pt-md-0 d-none d-md-block">
                    ...
                    <div className="rrss col-lg-4 mb-5 mb-md-0 d-flex align-items-center justify-content-end">
                        <h6>SÍGUENOS</h6>
                        <a href="https://www.instagram.com/lindsayyasociados/" target="_blank">
                            <img src="instagram2.svg" alt="icon" />
                        </a>
                    </div>
