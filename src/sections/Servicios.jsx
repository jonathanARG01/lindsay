...
const servicios = [
    ...
    {
        name: 'Contabilidad',
        description: 'Disponer de una contabilidad oportuna y confiable es una condición mínima para facilitar el control de las operaciones. El servicio de contabilidad busca reflejar la situación económica y financiera de la Empresa.',
        img: 'servicio2.jpg'
    },
    {
        name: 'tributaria',
        description: 'La complejidad de las leyes tributarias requieren dotar a la Empresas y a sus propietarios de una planificación tributaria, que les proporcione las herramientas necesarias para el adecuado uso de las ventajas tributarias existentes.',
        img: 'servicio3.jpg'
    },
    {
